   ...
   // var arrHabitMarks = ["1","1","1"]
    ...
    override func updateConstraints() {
        ...
        if  self.arrHabitMarks!.count <= 3 {
            ...
            constraintWidth.constant =  0 //CGFloat(( self.arrHabitMarks!.count * 50))
        }
    }
...
//                if  self.arrHabitMarks?.count ?? 0 <= 1 {
//                    return CGSize(width: 1 , height: 125)
//                }else{
//                    return CGSize(width: width1 - 10 , height: 125)
//                }
