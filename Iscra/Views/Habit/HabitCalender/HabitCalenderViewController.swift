...
extension HabitCalenderViewController {
    ...
    private func calenderSetup(){
        ...
        self.viewCalender.appearance.weekdayTextColor = UIColor.gray
        ...
        let dateStrings = ["2021-11-02","2021-11-03", "2021-11-05", "2021-11-14"]
    ...
    func circularViewSetup() {
        ...
        self.viewCircular.ringColor =  UIColor.orange
    }
}
// MARK:- Button Action
extension HabitCalenderViewController {
...
extension HabitCalenderViewController : FSCalendarDataSource, FSCalendarDelegate , FSCalendarDelegateAppearance{
    ...
    func calendar(_ calendar: FSCalendar,appearance: FSCalendarAppearance,titleDefaultColorFor date: Date) -> UIColor? {
        ...
        return UIColor.gray // Return Default Title Color
    }
    ...
    func calendar(_ calendar: FSCalendar,appearance: FSCalendarAppearance,fillDefaultColorFor date: Date) -> UIColor? {
        if self.eventsDateArray.contains(date) {
            return UIColor.orange // Return UIColor for eventsDateArray
        }
...
class CircularProgressBar: UIView {
    ...
    public var ringColor:UIColor = UIColor.gray {
        didSet{
